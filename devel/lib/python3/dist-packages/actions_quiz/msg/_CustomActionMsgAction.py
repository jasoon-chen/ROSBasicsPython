...
class CustomActionMsgAction(genpy.Message):
  _md5sum = "b52353fcc0c5aa631be593c0d73dd8c3"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.goal.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.goal.data = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.feedback.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
